...
class RegarderInterviewsViewSetAPITests(Neo4jTestCase):
    ...
    def test_list_regarder_interviews(self):
        url = reverse('interview-list', kwargs={'utilisateur_uuid': self.utilisateur.uuid})
    ...
    def test_create_regarder_interview_relation(self):
        ...
        self.assertTrue(self.utilisateur.regarder_interviews.is_connected(self.interview2))
    ...
    def test_destroy_regarder_interview_relation(self):
        ...
        self.assertFalse(self.utilisateur.regarder_interviews.is_connected(self.interview1))
