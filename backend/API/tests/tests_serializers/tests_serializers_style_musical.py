...
class StyleMusicalSerializerTests(Neo4jTestCase):
    ...
    def test_create_success(self):
        payload = {'name': 'Rock'}
        serializer = StyleMusicalSerializer(data=payload, context={'request': self.request})
    ...
    def test_update_success(self):
        ...
        serializer = StyleMusicalSerializer(instance=style, data=payload, context={'request': self.request})
        self.assertTrue(serializer.is_valid(), serializer.errors)
