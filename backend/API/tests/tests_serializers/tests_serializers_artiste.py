...
from ...serializers import ArtisteSerializer, ValidatorUnique, NotFound
...
class ArtisteSerializerTests(Neo4jTestCase):
    ...
    def test_create_success_with_nation(self):
        ...
        payload = {'name': 'Hikaru Utada', 'info': 'Chanteuse', 'nation_uuid': nation.uuid}
    ...
    def test_create_with_nonexistent_nation_raises_notfound(self):
        ...
        payload = {'name': 'UnknownNationArtist', 'nation_uuid': '00000000-0000-0000-0000-000000000000'}
        serializer = ArtisteSerializer(data=payload, context={'request': self.request})
        self.assertTrue(serializer.is_valid(), serializer.errors)
    ...
    def test_update_success_and_nation_replace(self):
        ...
        serializer = ArtisteSerializer(instance=artiste, data=payload, context={'request': self.request})
        self.assertTrue(serializer.is_valid(), serializer.errors)
    ...
    def test_update_raises_unique_on_conflict(self):
        ...
        serializer = ArtisteSerializer(instance=a1, data=payload, context={'request': self.request})
        self.assertTrue(serializer.is_valid(), serializer.errors)
        with self.assertRaises(ValidatorUnique):
            serializer.save()
    ...
    def test_update_with_nonexistent_nation_raises_notfound(self):
        ...
        payload = {'name': 'WillUpdate', 'info': 'still old', 'nation_uuid': '00000000-0000-0000-0000-000000000000'}
