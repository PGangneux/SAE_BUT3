...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        interview2 = Interview(uuid=2, titre="Interview 2", date=date.today(), occasion="Festival de la Musique Orléans", description="Interview 2 de l'Artiste 2", lieu="Orléans").save()
        ...
        extrait5 = Extrait(uuid=5, titre="Extrait 5", description="Extrait 1 de l'interview 2", youtube_url="9eLoUEBF6no", vimeo_url= "1128786403", uploaded_at=date.today(), duree=30).save()
        extrait6 = Extrait(uuid=6, titre="Extrait 6", description="Extrait 2 de l'interview 2", youtube_url="Wt14RXtzZxI", vimeo_url= "1128786928", uploaded_at=date.today(), duree=37).save()
        extrait7 = Extrait(uuid=7, titre="Extrait 7", description="Extrait 3 de l'interview 2", youtube_url="IqLw5KDf9Fg", vimeo_url= "1128788337", uploaded_at=date.today(), duree=149).save()
        extrait8 = Extrait(uuid=8, titre="Extrait 8", description="Extrait 4 de l'interview 2", youtube_url="uwIyaln-k8A", vimeo_url= "1128790175", uploaded_at=date.today(), duree=108).save()
        extrait9 = Extrait(uuid=9, titre="Extrait 9", description="Extrait 5 de l'interview 2", youtube_url="10MZrDXjby8", vimeo_url= None, uploaded_at=date.today(), duree=30).save()
        extrait10 = Extrait(uuid=10, titre="Extrait 10", description="Extrait 6 de l'interview 2", youtube_url="dUTuetpJ8_o", vimeo_url= None, uploaded_at=date.today(), duree=37).save()
        extrait11 = Extrait(uuid=11, titre="Extrait 11", description="Extrait 7 de l'interview 2", youtube_url="8GT8LUC1-EU", vimeo_url= None, uploaded_at=date.today(), duree=149).save()
        extrait12 = Extrait(uuid=12, titre="Extrait 12", description="Extrait 8 de l'interview 2", youtube_url="PO7FDDthezY", vimeo_url= None, uploaded_at=date.today(), duree=108).save()
        ...
        extrait5.interviewer.connect(artiste)
        extrait6.interviewer.connect(artiste)
        extrait7.interviewer.connect(artiste)
        extrait8.interviewer.connect(artiste)
        ...
        extrait9.interviewer.connect(artiste)
        extrait10.interviewer.connect(artiste)
        extrait11.interviewer.connect(artiste)
        extrait12.interviewer.connect(artiste)
