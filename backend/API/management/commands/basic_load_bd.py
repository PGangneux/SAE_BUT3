...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        interview = Interview(uuid=1000, titre="Interview 1", date=date.today(), occasion="Festival de la Musique", description="Interview 1 de l'Artiste 1", lieu="Paris").save()
        interview2 = Interview(uuid=1001, titre="Interview 2", date=date.today(), occasion="Festival de la Musique Orléans", description="Interview 2 de l'Artiste 2", lieu="Orléans").save()
