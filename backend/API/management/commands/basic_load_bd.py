...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        extrait1.interviews.connect(interview, {'position': 1})
        extrait2.interviews.connect(interview, {'position': 2})
        extrait3.interviews.connect(interview, {'position': 3})
        extrait4.interviews.connect(interview, {'position': 4})
