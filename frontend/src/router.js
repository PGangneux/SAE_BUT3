...
const routes = [
  ...
  { path: "/connection", component: () => import("./views/connection.vue") },
  ...
  { path: "/admin/user/edit/:id", component: () => import("./views/admin/edit/admin_edit_client.vue") },
  { path: "/admin/user/:id", component: () => import("./views/admin/admin_details_user.vue") },
