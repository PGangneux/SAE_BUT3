        ...
        <div class="f-flex flex-grow-1 p-5 mx-5">
            ...
            <form @submit.prevent="login" class="local d-flex flex-column my-5">
                ...
                <div class="d-flex flex-grow-1 gap-5 my-3 py-3">
                    <hr class="w-100 border-vert-neon border border-3"></hr>
                    <hr class="w-25 border-vert-neon border border-3"></hr>
                    <hr class="w-100 border-vert-neon border border-3"></hr>
                </div>
                <label class="d-flex flex-column px-5 fw-bold fs-5">
                    Mot de passe
...
input:-webkit-autofill{
  -webkit-box-shadow: 0 0 0 1000px #fff inset !important; /* remplace #fff par ta couleur */
